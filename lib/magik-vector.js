...
class MagikVector {
    ...
    add(vector) {
        ...
        if(this.length !== vector.length) {
            ...
            throw new RangeError(`Vectors must have the same number of coordinates, got ${this.length} and ${vector.length}`);
    ...
    getDirection() {
        ...
        if(this.length !== 2) {
            ...
            throw new RangeError(`Direction can only be calculated for 2D vectors, length = ${this.length}`);
